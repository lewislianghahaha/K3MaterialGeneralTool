...
namespace K3MaterialGeneralTool.Task
{
    ...
    public class Search
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable SearchHistoryRecord(string sdt, string edt, string fmaterialname, string fkui, string fbi,int typeid)
        {
            _sqlscript = sqlList.Get_SearchHistoryRecord(sdt,edt,fmaterialname,fkui,fbi, typeid);
            return UseSqlSearchIntoDt(1, _sqlscript);
        }
