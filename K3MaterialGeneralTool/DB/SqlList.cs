    ...
    public class SqlList
    {
        ...
        public string Get_SearchK3SourceRecord()
        {
            _result = $@"
                            ...
                            --安全标签类别
                            SELECT 20 TYPEID,b.FENTRYID ID,b.FDATAVALUE NAME,GETDATE() CreateDt
                            FROM T_BAS_ASSISTANTDATAENTRY  a
                            INNER JOIN dbo.T_BAS_ASSISTANTDATAENTRY_L b ON a.FENTRYID=b.FENTRYID
        ...
        ///13:包装罐(包装箱) 14:物料分组(辅助) 15:物料分组 16:存货类别 17:默认税率 18:基本单位 19:化学品分类 20:安全标签类别)</param>
                ...
                case 0:
                    _result = $@"
                            SELECT FMATERIALID ,FNUMBER ,FOLDNUMBER ,FMNEMONICCODE ,FMASTERID ,
                                   ...
                                   F_YTC_TEXT14,F_YTC_TEXT15,F_YTC_TEXT16,F_YTC_TEXT17,F_YTC_DECIMAL10,F_YTC_CHECKBOX,F_YTC_TEXT18,F_YTC_TEXT19,F_YTC_ASSISTANT10
        ...
        /// <summary>
        /// 根据导入过来的DT,查询并整理;若发现‘物料编码’已在DB内存在,并且单据状态为‘创建’,即删除(已取消,change date:20211122)
        ...
        {
            _result = $@"
                            SELECT FNUMBER FROM dbo.T_BD_MATERIAL WHERE FNUMBER IN ({fnumber}) /*AND FDOCUMENTSTATUS ='A'*/
                        ";
